...
#'
#' This function sets the optimal thread count for a specific \code{data.table} function based on the results obtained from \code{findOptimalThreadCount()}.
#'
...
#'
#' @param funcName The name of the \code{data.table} function for which to set the optimal thread count.
#'
#' @return NULL.
#'
#' @details Sets the thread count to the optimal value (fastest median runtime) for the specified \code{data.table} function.
#'
#' @export
#'
#' @import data.table
